...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/comp_upper_10000.png}
	\end{center}
\end{figure}
\begin{figure}
\begin{center}
	\includegraphics[width=0.7\textwidth]{images/comp_upper_100000.png}
\end{center}
\end{figure}
\begin{figure}
\begin{center}
	\includegraphics[width=0.7\textwidth]{images/comp_upper_1000000.png}
\end{center}
\end{figure}
\begin{figure}
\begin{center}
	\includegraphics[width=0.7\textwidth]{images/comp_upper_100000000.png}
\end{center}
\end{figure}
\subsubsection{toLowercase}
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/comp_lower_10000.png}
	\end{center}
\end{figure}
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/comp_lower_100000.png}
	\end{center}
\end{figure}
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/comp_lower_1000000.png}
	\end{center}
\end{figure}
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/comp_lower_100000000.png}
	\end{center}
\end{figure}
\subsubsection{countChar}
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/comp_count_10000.png}
	\end{center}
\end{figure}
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/comp_count_100000.png}
	\end{center}
\end{figure}
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/comp_count_1000000.png}
	\end{center}
\end{figure}
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\textwidth]{images/comp_count_100000000.png}
	\end{center}
\end{figure}
